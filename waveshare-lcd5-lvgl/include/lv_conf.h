 ...
 * - LV_OS_SDL2
 * - LV_OS_CUSTOM */
/* MEASURED 2026-07-25: LV_OS_FREERTOS + LV_DRAW_SW_DRAW_UNIT_CNT 2 gave
 * ZERO fps improvement on this board (8-9 fps either way) and cost ~19 KB
 * of internal heap. The bottleneck is framebuffer/vsync, not CPU render.
 * Left at NONE deliberately — don't "optimise" this back without measuring. */
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_DRAW_UNIT_CNT    1   /* >1 needs LV_USE_OS; see note there */
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        /* Cache shadows up to (shadow_width + radius) = 48 px. Costs 48^2
         * bytes of RAM, saves recomputing every shadow every frame. */
    ...
    /* Radial + conical gradients. Off by default; costs flash and some CPU,
     * but LV_GRAD_DIR_RADIAL / LV_GRAD_DIR_CONICAL do nothing without it. */
